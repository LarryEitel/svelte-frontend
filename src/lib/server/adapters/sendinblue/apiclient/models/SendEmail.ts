...
export function SendEmailFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendEmail {
	...
	return {
		...
		attachment: !exists(json, 'attachment')
			? undefined
			: (json['attachment'] as Array<any>).map(SendEmailAttachmentInnerFromJSON),
	...
	return {
		...
		attachment:
			value.attachment === undefined
				? undefined
				: (value.attachment as Array<any>).map(SendEmailAttachmentInnerToJSON),
