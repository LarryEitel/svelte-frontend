...
export function SendSmtpEmailFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendSmtpEmail {
	...
	return {
		...
		bcc: !exists(json, 'bcc')
			? undefined
			: (json['bcc'] as Array<any>).map(SendSmtpEmailBccInnerFromJSON),
		cc: !exists(json, 'cc')
			? undefined
			: (json['cc'] as Array<any>).map(SendSmtpEmailCcInnerFromJSON),
		...
		attachment: !exists(json, 'attachment')
			? undefined
			: (json['attachment'] as Array<any>).map(SendSmtpEmailAttachmentInnerFromJSON),
...
export function SendSmtpEmailToJSON(value?: SendSmtpEmail | null): any {
	...
	return {
		...
		bcc:
			value.bcc === undefined
				? undefined
				: (value.bcc as Array<any>).map(SendSmtpEmailBccInnerToJSON),
		cc:
			value.cc === undefined ? undefined : (value.cc as Array<any>).map(SendSmtpEmailCcInnerToJSON),
		...
		attachment:
			value.attachment === undefined
				? undefined
				: (value.attachment as Array<any>).map(SendSmtpEmailAttachmentInnerToJSON),
