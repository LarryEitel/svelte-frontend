...
import type { GetTransacEmailsListTransactionalEmailsInner } from './GetTransacEmailsListTransactionalEmailsInner';
import {
...
} from './GetTransacEmailsListTransactionalEmailsInner';
...
export function GetTransacEmailsListFromJSONTyped(
	json: any,
	...
	return {
		transactionalEmails: !exists(json, 'transactionalEmails')
			? undefined
			: (json['transactionalEmails'] as Array<any>).map(
					GetTransacEmailsListTransactionalEmailsInnerFromJSON
			  )
	};
}
	...
	return {
		transactionalEmails:
			value.transactionalEmails === undefined
				? undefined
				: (value.transactionalEmails as Array<any>).map(
						GetTransacEmailsListTransactionalEmailsInnerToJSON
				  )
	};
}
