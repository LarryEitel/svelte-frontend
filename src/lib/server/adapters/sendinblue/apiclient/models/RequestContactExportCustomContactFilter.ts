...
export function RequestContactExportCustomContactFilterFromJSON(
	json: any
...
export function RequestContactExportCustomContactFilterFromJSONTyped(
	...
	return {
		...
		actionForEmailCampaigns: !exists(json, 'actionForEmailCampaigns')
			? undefined
			: json['actionForEmailCampaigns'],
		actionForSmsCampaigns: !exists(json, 'actionForSmsCampaigns')
			? undefined
			: json['actionForSmsCampaigns'],
...
export function RequestContactExportCustomContactFilterToJSON(
	value?: RequestContactExportCustomContactFilter | null
): any {
	if (value === undefined) {
		return undefined;
	}
