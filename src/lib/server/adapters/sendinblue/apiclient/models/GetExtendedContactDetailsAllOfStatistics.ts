...
import type { GetExtendedContactDetailsAllOfStatisticsClicked } from './GetExtendedContactDetailsAllOfStatisticsClicked';
import {
...
} from './GetExtendedContactDetailsAllOfStatisticsClicked';
import type { GetExtendedContactDetailsAllOfStatisticsMessagesSent } from './GetExtendedContactDetailsAllOfStatisticsMessagesSent';
import {
...
} from './GetExtendedContactDetailsAllOfStatisticsMessagesSent';
import type { GetExtendedContactDetailsAllOfStatisticsOpened } from './GetExtendedContactDetailsAllOfStatisticsOpened';
import {
...
} from './GetExtendedContactDetailsAllOfStatisticsOpened';
import type { GetExtendedContactDetailsAllOfStatisticsUnsubscriptions } from './GetExtendedContactDetailsAllOfStatisticsUnsubscriptions';
import {
...
} from './GetExtendedContactDetailsAllOfStatisticsUnsubscriptions';
...
export function GetExtendedContactDetailsAllOfStatisticsFromJSON(
	json: any
...
export function GetExtendedContactDetailsAllOfStatisticsFromJSONTyped(
	...
	return {
		messagesSent: !exists(json, 'messagesSent')
			? undefined
			: (json['messagesSent'] as Array<any>).map(
					GetExtendedContactDetailsAllOfStatisticsMessagesSentFromJSON
			  ),
		hardBounces: !exists(json, 'hardBounces')
			? undefined
			: (json['hardBounces'] as Array<any>).map(
					GetExtendedContactDetailsAllOfStatisticsMessagesSentFromJSON
			  ),
		softBounces: !exists(json, 'softBounces')
			? undefined
			: (json['softBounces'] as Array<any>).map(
					GetExtendedContactDetailsAllOfStatisticsMessagesSentFromJSON
			  ),
		complaints: !exists(json, 'complaints')
			? undefined
			: (json['complaints'] as Array<any>).map(
					GetExtendedContactDetailsAllOfStatisticsMessagesSentFromJSON
			  ),
...
export function GetExtendedContactDetailsAllOfStatisticsToJSON(
	value?: GetExtendedContactDetailsAllOfStatistics | null
): any {
	if (value === undefined) {
		return undefined;
	}
	...
	return {
		messagesSent:
			value.messagesSent === undefined
				? undefined
				: (value.messagesSent as Array<any>).map(
						GetExtendedContactDetailsAllOfStatisticsMessagesSentToJSON
				  ),
		hardBounces:
			value.hardBounces === undefined
				? undefined
				: (value.hardBounces as Array<any>).map(
						GetExtendedContactDetailsAllOfStatisticsMessagesSentToJSON
				  ),
		softBounces:
			value.softBounces === undefined
				? undefined
				: (value.softBounces as Array<any>).map(
						GetExtendedContactDetailsAllOfStatisticsMessagesSentToJSON
				  ),
		complaints:
			value.complaints === undefined
				? undefined
				: (value.complaints as Array<any>).map(
						GetExtendedContactDetailsAllOfStatisticsMessagesSentToJSON
				  ),
		unsubscriptions: GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsToJSON(
			value.unsubscriptions
		),
		opened:
			value.opened === undefined
				? undefined
				: (value.opened as Array<any>).map(GetExtendedContactDetailsAllOfStatisticsOpenedToJSON),
		clicked:
			value.clicked === undefined
				? undefined
				: (value.clicked as Array<any>).map(GetExtendedContactDetailsAllOfStatisticsClickedToJSON),
