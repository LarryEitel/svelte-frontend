...
import type { GetChildInfoAllOfApiKeysV2 } from './GetChildInfoAllOfApiKeysV2';
import {
...
export function GetChildInfoAllOfApiKeysFromJSONTyped(
	json: any,
	...
	return {
		...
		v3: !exists(json, 'v3')
			? undefined
			: (json['v3'] as Array<any>).map(GetChildInfoAllOfApiKeysV3FromJSON)
	};
}
...
export function GetChildInfoAllOfApiKeysToJSON(value?: GetChildInfoAllOfApiKeys | null): any {
	...
	return {
		...
		v3:
			value.v3 === undefined
				? undefined
				: (value.v3 as Array<any>).map(GetChildInfoAllOfApiKeysV3ToJSON)
	};
}
