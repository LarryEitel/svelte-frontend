...
export function GetContactCampaignStatsOpenedInnerFromJSON(
	json: any
...
export function GetContactCampaignStatsOpenedInnerToJSON(
	value?: GetContactCampaignStatsOpenedInner | null
): any {
	if (value === undefined) {
		return undefined;
	}
