...
export function GetEmailEventReportEventsInnerFromJSONTyped(
	json: any,
...
export function GetEmailEventReportEventsInnerToJSON(
	value?: GetEmailEventReportEventsInner | null
): any {
	if (value === undefined) {
		return undefined;
	}
