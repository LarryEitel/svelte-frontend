...
import type { AbTestCampaignResultClickedLinks } from './AbTestCampaignResultClickedLinks';
import {
...
} from './AbTestCampaignResultClickedLinks';
import type { AbTestCampaignResultStatistics } from './AbTestCampaignResultStatistics';
import {
	AbTestCampaignResultStatisticsFromJSON,
	AbTestCampaignResultStatisticsFromJSONTyped,
	AbTestCampaignResultStatisticsToJSON
} from './AbTestCampaignResultStatistics';
...
export function AbTestCampaignResultFromJSONTyped(
	json: any,
	...
	return {
		...
		winningSubjectLine: !exists(json, 'winningSubjectLine')
			? undefined
			: json['winningSubjectLine'],
		openRate: !exists(json, 'openRate') ? undefined : json['openRate'],
		clickRate: !exists(json, 'clickRate') ? undefined : json['clickRate'],
		winningVersionRate: !exists(json, 'winningVersionRate')
			? undefined
			: json['winningVersionRate'],
		statistics: !exists(json, 'statistics')
			? undefined
			: AbTestCampaignResultStatisticsFromJSON(json['statistics']),
		clickedLinks: !exists(json, 'clickedLinks')
			? undefined
			: AbTestCampaignResultClickedLinksFromJSON(json['clickedLinks'])
	};
}
