...
export function GetTransacEmailsListTransactionalEmailsInnerFromJSON(
	json: any
...
export function GetTransacEmailsListTransactionalEmailsInnerToJSON(
	value?: GetTransacEmailsListTransactionalEmailsInner | null
): any {
	if (value === undefined) {
		return undefined;
	}
