...
import type { UpdateEmailCampaignRecipients } from './UpdateEmailCampaignRecipients';
import {
	UpdateEmailCampaignRecipientsFromJSON,
	UpdateEmailCampaignRecipientsFromJSONTyped,
	UpdateEmailCampaignRecipientsToJSON
} from './UpdateEmailCampaignRecipients';
import type { UpdateEmailCampaignSender } from './UpdateEmailCampaignSender';
import {
...
export function UpdateEmailCampaignFromJSONTyped(
	json: any,
	...
	return {
		...
		recipients: !exists(json, 'recipients')
			? undefined
			: UpdateEmailCampaignRecipientsFromJSON(json['recipients']),
