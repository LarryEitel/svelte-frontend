...
import type { GetTransacBlockedContactsContactsInnerReason } from './GetTransacBlockedContactsContactsInnerReason';
import {
...
} from './GetTransacBlockedContactsContactsInnerReason';
...
export function GetTransacBlockedContactsContactsInnerFromJSON(
	json: any
...
export function GetTransacBlockedContactsContactsInnerToJSON(
	value?: GetTransacBlockedContactsContactsInner | null
): any {
	if (value === undefined) {
		return undefined;
	}
