...
export function GetExtendedContactDetailsAllOfStatisticsOpenedFromJSON(
	json: any
...
export function GetExtendedContactDetailsAllOfStatisticsOpenedToJSON(
	value?: GetExtendedContactDetailsAllOfStatisticsOpened | null
): any {
	if (value === undefined) {
		return undefined;
	}
