...
export function GetSendersListSendersInnerIpsInnerFromJSON(
	json: any
...
export function GetSendersListSendersInnerIpsInnerToJSON(
	value?: GetSendersListSendersInnerIpsInner | null
): any {
	if (value === undefined) {
		return undefined;
	}
