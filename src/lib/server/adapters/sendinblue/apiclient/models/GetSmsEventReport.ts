...
export function GetSmsEventReportFromJSONTyped(
	json: any,
	...
	return {
		events: !exists(json, 'events')
			? undefined
			: (json['events'] as Array<any>).map(GetSmsEventReportEventsInnerFromJSON)
	};
}
	...
	return {
		events:
			value.events === undefined
				? undefined
				: (value.events as Array<any>).map(GetSmsEventReportEventsInnerToJSON)
	};
}
