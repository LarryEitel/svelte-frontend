...
import type { GetTransacBlockedContactsContactsInner } from './GetTransacBlockedContactsContactsInner';
import {
...
} from './GetTransacBlockedContactsContactsInner';
...
export function GetTransacBlockedContactsFromJSONTyped(
	json: any,
	...
	return {
		...
		contacts: !exists(json, 'contacts')
			? undefined
			: (json['contacts'] as Array<any>).map(GetTransacBlockedContactsContactsInnerFromJSON)
	};
}
	...
	return {
		...
		contacts:
			value.contacts === undefined
				? undefined
				: (value.contacts as Array<any>).map(GetTransacBlockedContactsContactsInnerToJSON)
	};
}
