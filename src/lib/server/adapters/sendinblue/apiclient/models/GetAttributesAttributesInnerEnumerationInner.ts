...
export function GetAttributesAttributesInnerEnumerationInnerFromJSON(
	json: any
...
export function GetAttributesAttributesInnerEnumerationInnerToJSON(
	value?: GetAttributesAttributesInnerEnumerationInner | null
): any {
	if (value === undefined) {
		return undefined;
	}
