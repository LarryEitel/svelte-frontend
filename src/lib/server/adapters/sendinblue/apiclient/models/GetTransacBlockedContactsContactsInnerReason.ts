...
export function GetTransacBlockedContactsContactsInnerReasonFromJSON(
	json: any
...
export function GetTransacBlockedContactsContactsInnerReasonToJSON(
	value?: GetTransacBlockedContactsContactsInnerReason | null
): any {
	if (value === undefined) {
		return undefined;
	}
