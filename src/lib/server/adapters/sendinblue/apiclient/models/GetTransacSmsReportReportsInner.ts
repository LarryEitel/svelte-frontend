...
export function GetTransacSmsReportReportsInnerFromJSON(
	json: any
): GetTransacSmsReportReportsInner {
	return GetTransacSmsReportReportsInnerFromJSONTyped(json, false);
}

export function GetTransacSmsReportReportsInnerFromJSONTyped(
	json: any,
...
export function GetTransacSmsReportReportsInnerToJSON(
	value?: GetTransacSmsReportReportsInner | null
): any {
	if (value === undefined) {
		return undefined;
	}
