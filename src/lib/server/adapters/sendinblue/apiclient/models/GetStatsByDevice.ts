...
export interface GetStatsByDevice {
	 ...
	 */
	desktop?: { [key: string]: GetDeviceBrowserStats | undefined };
	/**
	 * Statistics of the campaign on the basis of mobile devices
	 * @type {{ [key: string]: GetDeviceBrowserStats | undefined; }}
	 * @memberof GetStatsByDevice
	 */
	mobile?: { [key: string]: GetDeviceBrowserStats | undefined };
	/**
	 * Statistics of the campaign on the basis of tablet devices
	 * @type {{ [key: string]: GetDeviceBrowserStats | undefined; }}
	 * @memberof GetStatsByDevice
	 */
	tablet?: { [key: string]: GetDeviceBrowserStats | undefined };
	/**
	 * Statistics of the campaign on the basis of unknown devices
	 * @type {{ [key: string]: GetDeviceBrowserStats | undefined; }}
	 * @memberof GetStatsByDevice
	 */
	unknown?: { [key: string]: GetDeviceBrowserStats | undefined };
}
...
export function GetStatsByDeviceFromJSONTyped(
	json: any,
	...
	return {
		desktop: !exists(json, 'desktop')
			? undefined
			: mapValues(json['desktop'], GetDeviceBrowserStatsFromJSON),
		mobile: !exists(json, 'mobile')
			? undefined
			: mapValues(json['mobile'], GetDeviceBrowserStatsFromJSON),
		tablet: !exists(json, 'tablet')
			? undefined
			: mapValues(json['tablet'], GetDeviceBrowserStatsFromJSON),
		unknown: !exists(json, 'unknown')
			? undefined
			: mapValues(json['unknown'], GetDeviceBrowserStatsFromJSON)
	};
}
	...
	return {
		desktop:
			value.desktop === undefined
				? undefined
				: mapValues(value.desktop, GetDeviceBrowserStatsToJSON),
		mobile:
			value.mobile === undefined ? undefined : mapValues(value.mobile, GetDeviceBrowserStatsToJSON),
		tablet:
			value.tablet === undefined ? undefined : mapValues(value.tablet, GetDeviceBrowserStatsToJSON),
		unknown:
			value.unknown === undefined
				? undefined
				: mapValues(value.unknown, GetDeviceBrowserStatsToJSON)
	};
}
