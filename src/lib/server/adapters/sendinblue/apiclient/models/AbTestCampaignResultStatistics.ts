...
export function AbTestCampaignResultStatisticsFromJSONTyped(
	json: any,
...
export function AbTestCampaignResultStatisticsToJSON(
	value?: AbTestCampaignResultStatistics | null
): any {
	if (value === undefined) {
		return undefined;
	}
