...
export function GetChildInfoAllOfStatisticsFromJSONTyped(
	json: any,
	...
	return {
		previousMonthTotalSent: !exists(json, 'previousMonthTotalSent')
			? undefined
			: json['previousMonthTotalSent'],
		currentMonthTotalSent: !exists(json, 'currentMonthTotalSent')
			? undefined
			: json['currentMonthTotalSent'],
