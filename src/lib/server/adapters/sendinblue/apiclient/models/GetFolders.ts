...
import type { GetFoldersFoldersInner } from './GetFoldersFoldersInner';
import {
	GetFoldersFoldersInnerFromJSON,
	GetFoldersFoldersInnerFromJSONTyped,
	GetFoldersFoldersInnerToJSON
} from './GetFoldersFoldersInner';
...
export interface GetFolders {
	/**
	 *
	 * @type {Array<GetFoldersFoldersInner>}
	 * @memberof GetFolders
	 */
	folders?: Array<GetFoldersFoldersInner>;
	/**
...
export function GetFoldersFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetFolders {
	...
	return {
		folders: !exists(json, 'folders')
			? undefined
			: (json['folders'] as Array<any>).map(GetFoldersFoldersInnerFromJSON),
	...
	return {
		folders:
			value.folders === undefined
				? undefined
				: (value.folders as Array<any>).map(GetFoldersFoldersInnerToJSON),
		count: value.count
	};
}
