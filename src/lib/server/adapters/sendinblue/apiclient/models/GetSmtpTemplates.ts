...
export function GetSmtpTemplatesFromJSONTyped(
	json: any,
	...
	return {
		...
		templates: !exists(json, 'templates')
			? undefined
			: (json['templates'] as Array<any>).map(GetSmtpTemplateOverviewFromJSON)
	};
}
	...
	return {
		...
		templates:
			value.templates === undefined
				? undefined
				: (value.templates as Array<any>).map(GetSmtpTemplateOverviewToJSON)
	};
}
