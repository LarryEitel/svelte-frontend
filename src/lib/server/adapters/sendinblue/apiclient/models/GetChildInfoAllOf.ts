 ...
 *
 * @export
 * @interface GetChildInfoAllOf
 */
export interface GetChildInfoAllOf {
	/**
	 *
	 * @type {GetChildInfoAllOfCredits}
	 * @memberof GetChildInfoAllOf
	 */
...
/**
 * Check if a given object implements the GetChildInfoAllOf interface.
 */
export function instanceOfGetChildInfoAllOf(value: object): boolean {
	let isInstance = true;
...
export function GetChildInfoAllOfFromJSON(json: any): GetChildInfoAllOf {
	return GetChildInfoAllOfFromJSONTyped(json, false);
}

export function GetChildInfoAllOfFromJSONTyped(
	json: any,
...
export function GetChildInfoAllOfToJSON(value?: GetChildInfoAllOf | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
