...
import type { RemainingCreditModelChild } from './RemainingCreditModelChild';
import {
...
export function RemainingCreditModelFromJSONTyped(
	json: any,
