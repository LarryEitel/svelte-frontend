...
export function CreateSmsCampaignFromJSONTyped(
	json: any,
	...
	return {
		...
		recipients: !exists(json, 'recipients')
			? undefined
			: CreateSmsCampaignRecipientsFromJSON(json['recipients']),
