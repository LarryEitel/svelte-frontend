...
import type { GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription } from './GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription';
import {
...
import type { GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription } from './GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription';
import {
 ...
 */
export function instanceOfGetExtendedContactDetailsAllOfStatisticsUnsubscriptions(
	value: object
): boolean {
	let isInstance = true;
