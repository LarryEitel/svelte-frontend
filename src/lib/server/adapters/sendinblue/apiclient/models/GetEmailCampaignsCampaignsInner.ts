...
export function GetEmailCampaignsCampaignsInnerFromJSON(
	json: any
): GetEmailCampaignsCampaignsInner {
	return GetEmailCampaignsCampaignsInnerFromJSONTyped(json, false);
}

export function GetEmailCampaignsCampaignsInnerFromJSONTyped(
	json: any,
...
export function GetEmailCampaignsCampaignsInnerToJSON(
	value?: GetEmailCampaignsCampaignsInner | null
): any {
	if (value === undefined) {
		return undefined;
	}
