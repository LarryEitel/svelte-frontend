...
export function GetContactCampaignStatsTransacAttributesInnerFromJSON(
	json: any
...
export function GetContactCampaignStatsTransacAttributesInnerToJSON(
	value?: GetContactCampaignStatsTransacAttributesInner | null
): any {
	if (value === undefined) {
		return undefined;
	}
	...
	return {
		orderDate: value.orderDate.toISOString().substr(0, 10),
