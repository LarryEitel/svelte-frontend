...
const Schema: z.ZodType<Prisma.ActivityUncheckedCreateNestedManyWithoutProjectInput> = z
	.object({
		create: z
			.union([
...
export const ActivityUncheckedCreateNestedManyWithoutProjectInputObjectSchema = Schema;
