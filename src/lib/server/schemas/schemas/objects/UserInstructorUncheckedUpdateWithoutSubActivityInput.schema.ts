...
const Schema: z.ZodType<Prisma.UserInstructorUncheckedUpdateWithoutSubActivityInput> = z
	.object({
		id: z
...
export const UserInstructorUncheckedUpdateWithoutSubActivityInputObjectSchema = Schema;
