...
const Schema: z.ZodType<Prisma.ActivityUncheckedUpdateManyWithoutProjectNestedInput> = z
	.object({
		create: z
			.union([
...
export const ActivityUncheckedUpdateManyWithoutProjectNestedInputObjectSchema = Schema;
