...
const Schema: z.ZodType<Prisma.ActivityUncheckedCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const ActivityUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
