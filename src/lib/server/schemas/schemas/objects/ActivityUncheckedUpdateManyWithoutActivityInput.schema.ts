...
const Schema: z.ZodType<Prisma.ActivityUncheckedUpdateManyWithoutActivityInput> = z
	.object({
		id: z
...
export const ActivityUncheckedUpdateManyWithoutActivityInputObjectSchema = Schema;
