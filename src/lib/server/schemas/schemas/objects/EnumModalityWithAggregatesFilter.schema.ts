...
import { NestedEnumModalityWithAggregatesFilterObjectSchema } from './NestedEnumModalityWithAggregatesFilter.schema';
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema';
import { NestedEnumModalityFilterObjectSchema } from './NestedEnumModalityFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnumModalityWithAggregatesFilter> = z
	.object({
...
export const EnumModalityWithAggregatesFilterObjectSchema = Schema;
