...
const Schema: z.ZodType<Prisma.NestedEnumStructorInvitationStatusWithAggregatesFilter> = z
	.object({
...
export const NestedEnumStructorInvitationStatusWithAggregatesFilterObjectSchema = Schema;
