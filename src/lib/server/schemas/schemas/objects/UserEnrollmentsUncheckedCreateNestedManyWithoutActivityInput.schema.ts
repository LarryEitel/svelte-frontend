...
const Schema: z.ZodType<Prisma.UserEnrollmentsUncheckedCreateNestedManyWithoutActivityInput> = z
	.object({
		create: z
			.union([
...
export const UserEnrollmentsUncheckedCreateNestedManyWithoutActivityInputObjectSchema = Schema;
