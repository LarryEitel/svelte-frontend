...
const Schema: z.ZodType<Prisma.SubActivityUncheckedUpdateManyWithoutActivityNestedInput> = z
	.object({
		create: z
			.union([
...
export const SubActivityUncheckedUpdateManyWithoutActivityNestedInputObjectSchema = Schema;
