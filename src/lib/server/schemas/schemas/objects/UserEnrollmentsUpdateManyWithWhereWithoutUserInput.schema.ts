...
const Schema: z.ZodType<Prisma.UserEnrollmentsUpdateManyWithWhereWithoutUserInput> = z
	.object({
...
export const UserEnrollmentsUpdateManyWithWhereWithoutUserInputObjectSchema = Schema;
