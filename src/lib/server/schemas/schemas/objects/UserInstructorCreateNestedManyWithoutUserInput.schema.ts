...
const Schema: z.ZodType<Prisma.UserInstructorCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const UserInstructorCreateNestedManyWithoutUserInputObjectSchema = Schema;
