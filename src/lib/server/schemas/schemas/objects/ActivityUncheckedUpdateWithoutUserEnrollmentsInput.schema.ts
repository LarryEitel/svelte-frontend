...
const Schema: z.ZodType<Prisma.ActivityUncheckedUpdateWithoutUserEnrollmentsInput> = z
	.object({
		id: z
...
export const ActivityUncheckedUpdateWithoutUserEnrollmentsInputObjectSchema = Schema;
