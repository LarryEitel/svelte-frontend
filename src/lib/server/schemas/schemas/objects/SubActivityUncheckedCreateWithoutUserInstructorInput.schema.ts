...
const Schema: z.ZodType<Prisma.SubActivityUncheckedCreateWithoutUserInstructorInput> = z
	.object({
...
export const SubActivityUncheckedCreateWithoutUserInstructorInputObjectSchema = Schema;
