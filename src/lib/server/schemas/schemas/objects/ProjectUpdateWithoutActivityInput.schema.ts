...
import { ProgramUpdateOneWithoutProjectNestedInputObjectSchema } from './ProgramUpdateOneWithoutProjectNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.ProjectUpdateWithoutActivityInput> = z
	.object({
		id: z
		...
		visibility: z
			...
			.optional(),
		Program: z.lazy(() => ProgramUpdateOneWithoutProjectNestedInputObjectSchema).optional()
	})
	.strict();

export const ProjectUpdateWithoutActivityInputObjectSchema = Schema;
