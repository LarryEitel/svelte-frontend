...
const Schema: z.ZodType<Prisma.UserEnrollmentsUncheckedUpdateWithoutActivityInput> = z
	.object({
		id: z
...
export const UserEnrollmentsUncheckedUpdateWithoutActivityInputObjectSchema = Schema;
