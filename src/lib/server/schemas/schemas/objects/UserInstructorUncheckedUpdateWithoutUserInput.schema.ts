...
const Schema: z.ZodType<Prisma.UserInstructorUncheckedUpdateWithoutUserInput> = z
	.object({
		id: z
...
export const UserInstructorUncheckedUpdateWithoutUserInputObjectSchema = Schema;
