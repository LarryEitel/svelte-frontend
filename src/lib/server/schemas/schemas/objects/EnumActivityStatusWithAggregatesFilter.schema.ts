...
import { NestedEnumActivityStatusWithAggregatesFilterObjectSchema } from './NestedEnumActivityStatusWithAggregatesFilter.schema';
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema';
import { NestedEnumActivityStatusFilterObjectSchema } from './NestedEnumActivityStatusFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnumActivityStatusWithAggregatesFilter> = z
	.object({
...
export const EnumActivityStatusWithAggregatesFilterObjectSchema = Schema;
