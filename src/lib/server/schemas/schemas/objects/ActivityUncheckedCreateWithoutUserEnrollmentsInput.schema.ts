...
const Schema: z.ZodType<Prisma.ActivityUncheckedCreateWithoutUserEnrollmentsInput> = z
	.object({
...
export const ActivityUncheckedCreateWithoutUserEnrollmentsInputObjectSchema = Schema;
