...
const Schema: z.ZodType<Prisma.UserEnrollmentsCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const UserEnrollmentsCreateNestedManyWithoutUserInputObjectSchema = Schema;
