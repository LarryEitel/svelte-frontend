...
import { UserEnrollmentsUpdateManyWithoutActivityNestedInputObjectSchema } from './UserEnrollmentsUpdateManyWithoutActivityNestedInput.schema';
import { SubActivityUpdateManyWithoutActivityNestedInputObjectSchema } from './SubActivityUpdateManyWithoutActivityNestedInput.schema';
import { UserUpdateOneRequiredWithoutActivityNestedInputObjectSchema } from './UserUpdateOneRequiredWithoutActivityNestedInput.schema';
import { ProjectUpdateOneRequiredWithoutActivityNestedInputObjectSchema } from './ProjectUpdateOneRequiredWithoutActivityNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.ActivityUpdateInput> = z
	.object({
		id: z
		...
		updatedAt: z
			...
			.optional(),
		UserEnrollments: z
			.lazy(() => UserEnrollmentsUpdateManyWithoutActivityNestedInputObjectSchema)
			.optional(),
		SubActivity: z
			.lazy(() => SubActivityUpdateManyWithoutActivityNestedInputObjectSchema)
			.optional(),
		User: z.lazy(() => UserUpdateOneRequiredWithoutActivityNestedInputObjectSchema).optional(),
		Project: z.lazy(() => ProjectUpdateOneRequiredWithoutActivityNestedInputObjectSchema).optional()
	})
	.strict();

export const ActivityUpdateInputObjectSchema = Schema;
