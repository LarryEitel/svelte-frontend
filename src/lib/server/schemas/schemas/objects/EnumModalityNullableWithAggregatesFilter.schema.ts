...
import { NestedEnumModalityNullableWithAggregatesFilterObjectSchema } from './NestedEnumModalityNullableWithAggregatesFilter.schema';
import { NestedIntNullableFilterObjectSchema } from './NestedIntNullableFilter.schema';
import { NestedEnumModalityNullableFilterObjectSchema } from './NestedEnumModalityNullableFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnumModalityNullableWithAggregatesFilter> = z
	.object({
		equals: z
			.lazy(() => ModalitySchema)
			.optional()
...
export const EnumModalityNullableWithAggregatesFilterObjectSchema = Schema;
