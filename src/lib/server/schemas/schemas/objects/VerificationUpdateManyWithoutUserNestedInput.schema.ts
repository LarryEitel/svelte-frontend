...
const Schema: z.ZodType<Prisma.VerificationUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const VerificationUpdateManyWithoutUserNestedInputObjectSchema = Schema;
