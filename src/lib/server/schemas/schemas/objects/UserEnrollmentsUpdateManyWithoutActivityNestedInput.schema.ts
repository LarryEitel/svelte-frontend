...
const Schema: z.ZodType<Prisma.UserEnrollmentsUpdateManyWithoutActivityNestedInput> = z
	.object({
		create: z
			.union([
...
export const UserEnrollmentsUpdateManyWithoutActivityNestedInputObjectSchema = Schema;
