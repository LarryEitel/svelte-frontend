...
import { NestedEnumTargetAudienceWithAggregatesFilterObjectSchema } from './NestedEnumTargetAudienceWithAggregatesFilter.schema';
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema';
import { NestedEnumTargetAudienceFilterObjectSchema } from './NestedEnumTargetAudienceFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnumTargetAudienceWithAggregatesFilter> = z
	.object({
...
export const EnumTargetAudienceWithAggregatesFilterObjectSchema = Schema;
