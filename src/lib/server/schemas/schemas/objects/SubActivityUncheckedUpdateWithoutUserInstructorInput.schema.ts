...
const Schema: z.ZodType<Prisma.SubActivityUncheckedUpdateWithoutUserInstructorInput> = z
	.object({
		id: z
...
export const SubActivityUncheckedUpdateWithoutUserInstructorInputObjectSchema = Schema;
