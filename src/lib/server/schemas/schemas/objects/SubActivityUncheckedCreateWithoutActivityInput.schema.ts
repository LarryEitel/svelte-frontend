...
const Schema: z.ZodType<Prisma.SubActivityUncheckedCreateWithoutActivityInput> = z
	.object({
...
export const SubActivityUncheckedCreateWithoutActivityInputObjectSchema = Schema;
