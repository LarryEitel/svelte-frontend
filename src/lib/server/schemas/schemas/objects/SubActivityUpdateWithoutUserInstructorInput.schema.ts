...
const Schema: z.ZodType<Prisma.SubActivityUpdateWithoutUserInstructorInput> = z
	.object({
		id: z
...
export const SubActivityUpdateWithoutUserInstructorInputObjectSchema = Schema;
