...
const Schema: z.ZodType<Prisma.UserEnrollmentsUncheckedUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const UserEnrollmentsUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
