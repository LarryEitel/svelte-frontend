...
import { UserEnrollmentsUpdateManyWithoutUserNestedInputObjectSchema } from './UserEnrollmentsUpdateManyWithoutUserNestedInput.schema';
import { ActivityUpdateManyWithoutUserNestedInputObjectSchema } from './ActivityUpdateManyWithoutUserNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.UserUpdateWithoutUserInstructorInput> = z
	.object({
		id: z
		...
		UserEnrollments: z
			.lazy(() => UserEnrollmentsUpdateManyWithoutUserNestedInputObjectSchema)
			.optional(),
		Activity: z.lazy(() => ActivityUpdateManyWithoutUserNestedInputObjectSchema).optional()
	})
	.strict();

export const UserUpdateWithoutUserInstructorInputObjectSchema = Schema;
