...
const Schema: z.ZodType<Prisma.UserEnrollmentsUncheckedUpdateManyWithoutUserEnrollmentsInput> = z
	.object({
		id: z
...
export const UserEnrollmentsUncheckedUpdateManyWithoutUserEnrollmentsInputObjectSchema = Schema;
