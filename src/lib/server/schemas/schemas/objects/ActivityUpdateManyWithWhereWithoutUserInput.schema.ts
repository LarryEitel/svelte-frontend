...
const Schema: z.ZodType<Prisma.ActivityUpdateManyWithWhereWithoutUserInput> = z
	.object({
...
export const ActivityUpdateManyWithWhereWithoutUserInputObjectSchema = Schema;
