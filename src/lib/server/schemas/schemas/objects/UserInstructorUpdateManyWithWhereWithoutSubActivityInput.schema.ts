...
const Schema: z.ZodType<Prisma.UserInstructorUpdateManyWithWhereWithoutSubActivityInput> = z
	.object({
...
export const UserInstructorUpdateManyWithWhereWithoutSubActivityInputObjectSchema = Schema;
