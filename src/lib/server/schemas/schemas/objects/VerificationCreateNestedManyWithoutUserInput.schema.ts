...
const Schema: z.ZodType<Prisma.VerificationCreateNestedManyWithoutUserInput> = z
	.object({
		create: z
			.union([
...
export const VerificationCreateNestedManyWithoutUserInputObjectSchema = Schema;
