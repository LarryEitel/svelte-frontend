...
const Schema: z.ZodType<Prisma.ActivityUncheckedUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const ActivityUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
