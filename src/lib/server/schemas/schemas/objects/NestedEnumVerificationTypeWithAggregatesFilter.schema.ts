...
const Schema: z.ZodType<Prisma.NestedEnumVerificationTypeWithAggregatesFilter> = z
	.object({
...
export const NestedEnumVerificationTypeWithAggregatesFilterObjectSchema = Schema;
