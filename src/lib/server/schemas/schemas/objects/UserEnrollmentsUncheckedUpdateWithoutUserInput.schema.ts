...
const Schema: z.ZodType<Prisma.UserEnrollmentsUncheckedUpdateWithoutUserInput> = z
	.object({
		id: z
...
export const UserEnrollmentsUncheckedUpdateWithoutUserInputObjectSchema = Schema;
