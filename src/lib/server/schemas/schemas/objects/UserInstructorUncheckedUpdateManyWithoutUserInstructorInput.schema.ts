...
const Schema: z.ZodType<Prisma.UserInstructorUncheckedUpdateManyWithoutUserInstructorInput> = z
	.object({
		id: z
...
export const UserInstructorUncheckedUpdateManyWithoutUserInstructorInputObjectSchema = Schema;
