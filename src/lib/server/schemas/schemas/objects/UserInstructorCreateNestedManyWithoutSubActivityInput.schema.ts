...
const Schema: z.ZodType<Prisma.UserInstructorCreateNestedManyWithoutSubActivityInput> = z
	.object({
		create: z
			.union([
...
export const UserInstructorCreateNestedManyWithoutSubActivityInputObjectSchema = Schema;
