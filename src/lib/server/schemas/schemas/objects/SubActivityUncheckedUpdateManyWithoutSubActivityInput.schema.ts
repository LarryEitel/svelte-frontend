...
const Schema: z.ZodType<Prisma.SubActivityUncheckedUpdateManyWithoutSubActivityInput> = z
	.object({
		id: z
...
export const SubActivityUncheckedUpdateManyWithoutSubActivityInputObjectSchema = Schema;
