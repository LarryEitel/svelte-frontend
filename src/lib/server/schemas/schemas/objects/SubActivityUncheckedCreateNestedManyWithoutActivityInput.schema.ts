...
const Schema: z.ZodType<Prisma.SubActivityUncheckedCreateNestedManyWithoutActivityInput> = z
	.object({
		create: z
			.union([
...
export const SubActivityUncheckedCreateNestedManyWithoutActivityInputObjectSchema = Schema;
