...
const Schema: z.ZodType<Prisma.UserInstructorUncheckedUpdateManyWithoutUserNestedInput> = z
	.object({
		create: z
			.union([
...
export const UserInstructorUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
