...
const Schema: z.ZodType<Prisma.ActivityUncheckedUpdateWithoutSubActivityInput> = z
	.object({
		id: z
...
export const ActivityUncheckedUpdateWithoutSubActivityInputObjectSchema = Schema;
