...
const Schema: z.ZodType<Prisma.NestedEnumEventVisibilityWithAggregatesFilter> = z
	.object({
...
export const NestedEnumEventVisibilityWithAggregatesFilterObjectSchema = Schema;
