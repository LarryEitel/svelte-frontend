...
import { UserUpdateOneRequiredWithoutVerificationNestedInputObjectSchema } from './UserUpdateOneRequiredWithoutVerificationNestedInput.schema';
...
const Schema: z.ZodType<Prisma.VerificationUpdateInput> = z
	.object({
		id: z
			.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)])
			.optional(),
		user: z.lazy(() => UserUpdateOneRequiredWithoutVerificationNestedInputObjectSchema).optional(),
		token: z
...
export const VerificationUpdateInputObjectSchema = Schema;
