...
const Schema: z.ZodType<Prisma.VerificationUncheckedUpdateWithoutUserInput> = z
	.object({
		id: z
...
export const VerificationUncheckedUpdateWithoutUserInputObjectSchema = Schema;
