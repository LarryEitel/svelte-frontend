...
import { UserEnrollmentsUncheckedUpdateManyWithoutActivityNestedInputObjectSchema } from './UserEnrollmentsUncheckedUpdateManyWithoutActivityNestedInput.schema';
import { SubActivityUncheckedUpdateManyWithoutActivityNestedInputObjectSchema } from './SubActivityUncheckedUpdateManyWithoutActivityNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.ActivityUncheckedUpdateWithoutProjectInput> = z
	.object({
		id: z
		...
		updatedAt: z
			...
			.optional(),
		UserEnrollments: z
			.lazy(() => UserEnrollmentsUncheckedUpdateManyWithoutActivityNestedInputObjectSchema)
			.optional(),
		SubActivity: z
			.lazy(() => SubActivityUncheckedUpdateManyWithoutActivityNestedInputObjectSchema)
			.optional()
	})
	.strict();

export const ActivityUncheckedUpdateWithoutProjectInputObjectSchema = Schema;
