...
const Schema: z.ZodType<Prisma.ActivityUncheckedCreateWithoutSubActivityInput> = z
	.object({
...
export const ActivityUncheckedCreateWithoutSubActivityInputObjectSchema = Schema;
