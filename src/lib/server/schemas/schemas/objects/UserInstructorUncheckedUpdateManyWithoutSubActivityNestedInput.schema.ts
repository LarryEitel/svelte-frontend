...
const Schema: z.ZodType<Prisma.UserInstructorUncheckedUpdateManyWithoutSubActivityNestedInput> = z
	.object({
		create: z
			.union([
...
export const UserInstructorUncheckedUpdateManyWithoutSubActivityNestedInputObjectSchema = Schema;
